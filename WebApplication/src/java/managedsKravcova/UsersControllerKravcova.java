...
import sessionsShcherbuk.UsersFacade;
...
@SessionScoped
public class UsersControllerKravcova implements Serializable {
    ...
    public UsersControllerKravcova() {
    }
    ...
    public String create() {
        try {
            ...
            JsfUtilLishtvan.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UsersCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtilLishtvan.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UsersUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtilLishtvan.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtilLishtvan.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UsersDeleted"));
        } catch (Exception e) {
            JsfUtilLishtvan.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Users getUsers(java.lang.String id) {
        return (Users)ejbFacade.find(id);
    }
    ...
    public static class UsersControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            UsersControllerKravcova controller = (UsersControllerKravcova) facesContext.getApplication().getELResolver().
