...
import sessionsShcherbuk.TicketsFacadeShcherbuk;
...
@SessionScoped
public class TicketsControllerKravcova implements Serializable {

    protected Tickets current;
    private DataModel items = null;
    @EJB
    protected sessionsShcherbuk.TicketsFacadeShcherbuk ejbFacade;
    protected PaginationHelperLishtvan pagination;
    protected int selectedItemIndex;

    private String[] activities = {"ACTIVE", "INACTIVE"};
    
    public TicketsControllerKravcova() {
    }
    ...
    protected TicketsFacadeShcherbuk getFacade() {
        return ejbFacade;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtilLishtvan.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TicketsCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtilLishtvan.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TicketsUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtilLishtvan.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtilLishtvan.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TicketsDeleted"));
        } catch (Exception e) {
            JsfUtilLishtvan.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Tickets getTickets(java.lang.String id) {
        return (Tickets)ejbFacade.find(id);
    }
    ...
    public static class TicketsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TicketsControllerKravcova controller = (TicketsControllerKravcova) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tickets) {
                ...
                return getStringKey(o.getTicketCode());
            } else {
